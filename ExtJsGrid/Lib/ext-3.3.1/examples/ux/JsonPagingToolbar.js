var T = Ext.Toolbar;
Ext.ux.JsonPagingToolbar = Ext.extend(Ext.Toolbar, {
    ...
    */
    ...
    this.inputItem = new Ext.form.NumberField({
        ...
        Ext.ux.JsonPagingToolbar.superclass.initComponent.call(this);
        this.addEvents(

        /**
        * @event change
        * Fires after the active page has been changed.
        * @param {Ext.ux.JsonPagingToolbar} this
    ...
    */
    ...
    onDestroy: function () {
        this.bindStore(null);
        Ext.ux.JsonPagingToolbar.superclass.onDestroy.call(this);
    }
});

//Ext.reg('jsonpaging', Ext.ux.JsonPagingToolbar);